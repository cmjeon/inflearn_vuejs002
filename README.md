...
- 예제도 풍부
### 오픈 소스 사용하기
- 스타 수, commit, contiributors, 최종 커밋일자를 확인할 것
- Promise 기반 : javascript의 비동기 패턴
javascript의 비동기 패턴은..
1. callback
2. promise
3. promise + generator
...
- method의 this와 비동기 함수 호출 후 this는 다르다

## 웹 서비스에서의 클라이언트와 서버와의 HTTP 통신 구조
- 

## 크롬 개발자 도구 네트워크 패널 보는 방법
- 위의 샘플을 실행하고 XHR탭에서 결과를 확인
